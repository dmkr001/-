...
public:
    ...
    void computeJacobianExtrinsic(const vpPoint &_P, vpMatrix &_J)
    {
        ...
        _J[0][1]=0;
        _J[0][2]=xi_[0]*_P.get_X()/(_P.get_Z()*_P.get_Z());
        _J[0][3]=xi_[0]*(_P.get_X()/_P.get_Z())*(_P.get_Y()/_P.get_Z());
        _J[0][4]=-xi_[0]*(1+(_P.get_X()*_P.get_X())/(_P.get_Z()*_P.get_Z()));
        _J[0][5]=xi_[0]*_P.get_Y()/_P.get_Z();

        _J[1][0]=0;
        _J[1][1]=-xi_[1]/_P.get_Z();
        _J[1][2]=xi_[1]*_P.get_Y()/(_P.get_Z()*_P.get_Z());
        _J[1][3]=xi_[1]*(1+(_P.get_Y()*_P.get_Y())/(_P.get_Z()*_P.get_Z()));
        _J[1][4]=-xi_[1]*_P.get_X()*_P.get_Y()/(_P.get_Z()*_P.get_Z());
        _J[1][5]=-xi_[1]*_P.get_X()/_P.get_Z();
